...
(defn collection
  [name]
  (str "com.etzhayyim.oil-coverage." name))

(def cell-specs {
  :get {:legacy-cell "com-etzhayyim-apps-oil-coverage-get"
     :phase :event
  ...
  :listtargets {:legacy-cell "com-etzhayyim-apps-oil-coverage-listTargets"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "listtargets")]
     :required-gates common-gates
     :trigger "manifest cell listtargets"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :listbackbone {:legacy-cell "com-etzhayyim-apps-oil-coverage-listBackbone"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "listbackbone")]
     :required-gates common-gates
     :trigger "manifest cell listbackbone"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  ...
  :domain-knowledge {:legacy-cell "domain-knowledge"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :coveragesnapshot {:legacy-cell "com-etzhayyim-apps-oil-coverageSnapshot"
     :phase :event
     :murakumo-node "reuben"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :coveragetarget {:legacy-cell "com-etzhayyim-apps-oil-coverageTarget"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "coveragetarget")]
     :required-gates common-gates
     :trigger "manifest cell coveragetarget"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
